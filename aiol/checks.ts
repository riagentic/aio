...
export const checkStructure: Checker = async (ctx) => {
  ...
  if (cellFiles.length > 3) {
    ...
    // `cell/` or `cells/` — both are valid; don't nag about the choice (a crypto wallet).
...
export const checkPerformance: Checker = (ctx) => {
  ...
  // Skips (a crypto wallet false-positives): the delay-0 yield idiom
...
export const checkSecurity: Checker = (ctx) => {
  ...
  // .env files committed — only warn if it isn't already gitignored (wallet report #7)
  try {
...
export const checkUI: Checker = (ctx) => {
  ...
  // "aio/server" is the explicit server-only entry (wallet report #1): the whole module
  ...
  // AIO-424 (a crypto wallet): server-only SYMBOLS that live in the isomorphic "aio"
...
export const checkPatterns: Checker = (ctx) => {
  ...
  for (const file of sourceFiles) {
    ...
    // A `transaction: true` cell (wallet report #2) reads a STABLE snapshot across
...
// ══════════════════════════════════════════════════════════════════════
// 14. DUPLICATE IMPORTS (a crypto wallet 2026-07-24)
// ══════════════════════════════════════════════════════════════════════
...
export const checkUpgrade: Checker = (ctx) => {
  ...
  // The DYNAMIC variant of the same migration (a crypto wallet 2026-07-26): the lazy
  ...
  // "createDB is not a function" (a crypto wallet's nft-cache silently stopped
...
// ══════════════════════════════════════════════════════════════════════
// 17. CALLER-SIDE POST-AWAIT READS (a crypto wallet 2026-07-26)
// ══════════════════════════════════════════════════════════════════════
//
...
// ══════════════════════════════════════════════════════════════════════
// 18. WORKER CELLS READING PEER CELLS (a crypto wallet 2026-07-26 — the line in the sand)
// ══════════════════════════════════════════════════════════════════════
//
