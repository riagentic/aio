## am ui - The aio UI manager (aui)

## General 
- aui is aio electron application for managing and monitoring aio applicationsa
...
- it has vertical tabs so user can easily switch between details of each aio application
...
- provides all trojan api to diagnose and get details from the app (like buttons to run methods of each cells:, etc.)
