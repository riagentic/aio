 ...
 *  bundles an npm package written in CommonJS (a crypto wallet's client graph: 13 of 14
...
export function auditClientGraph(opts: {
  ...
  // in the FILE instead of in its name (trading-app report §9.1). The convention is good
