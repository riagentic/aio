...
function _applyPatch(prev: Record<string, unknown> | null, data: { $p: Record<string, unknown>; $d?: string[] }): Record<string, unknown> {
...
const _ipc: AioIPC | null = (typeof window !== 'undefined' && (window as unknown as Record<string, unknown>).__aioIPC as AioIPC) || null
...
function _notify() { _stateVersion++; for (const fn of _listeners) fn(_state) }
...
function _getSnapshot(): unknown { return _state }
function _getServerSnapshot(): unknown { return null }
