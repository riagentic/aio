 ...
 *  every method (a prediction-market app). Absent = open (as before). Server-origin dispatches
 ...
 *  returns (the "no value" cases) resolve `Promise<void>`. AIO-427 (a crypto wallet/a news app):
