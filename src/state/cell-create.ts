...
export function cell<
  ...
  // accessors surface on the return type instead of being inert config (a crypto wallet).
  ...
  // ref (e.g. testCell's typed send surface) to {}. (a trading platform B8)
...
>(
  ...
  // type-accessible instead of inert config (a crypto wallet).
