 ...
 *  on `undefined` as though it were data (a crypto wallet 2026-07-28 #3: a lock screen
...
export function bindCellReactive(
  ...
  for (const key of Object.keys(initialState)) {
    ...
    Object.defineProperty(def, key, {
      get() {
        ...
        // Register a SERVER subscription for this cell (a crypto wallet 2026-07-18):
  ...
  // AIO-422 (a prediction-market app): bind selectors on the browser cell too — they're pure
