 ...
 *  `cell.total()`. Deps-form selectors are always zero-arg. (a crypto wallet, a prediction-market app Bad#1) */
...
> = {
  ...
  /** Transactional async methods (wallet report #2): reads see a STABLE snapshot taken
