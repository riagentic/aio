...
.aio-th { text-align: left; font-weight: 600; font-size: .76rem; letter-spacing: .04em; text-transform: uppercase; color: var(--aio-ui-ink-soft); padding: .55em .7em; border-bottom: 1px solid var(--aio-ui-line); }
...
.aio-toast { display: flex; align-items: center; gap: .6em; padding: .7em .9em; border-radius: var(--aio-ui-radius); background: var(--aio-ui-bg); color: var(--aio-ui-ink); border: 1px solid var(--aio-ui-line); border-left: 3px solid var(--aio-ui-ink-soft); box-shadow: 0 6px 20px rgba(0,0,0,.18); font-family: var(--aio-ui-font); animation: aio-toast-in .18s ease-out; }
.aio-toast--success { border-left-color: #2f9e5e; }
.aio-toast--warn { border-left-color: #d99117; }
.aio-toast--error { border-left-color: var(--aio-ui-danger); }
...
.aio-md__quote { margin: 0 0 .8em; padding: .2em 0 .2em 1em; border-left: 3px solid var(--aio-ui-line); color: var(--aio-ui-ink-soft); }
