 ...
 *  AIO-423 (a prediction-market app): without this, mobile Chrome falls back to a 980px layout
...
<body>
  ...
  <script type="module">${devWsScript()}
    ...
    function _fail(stage, err) {
      // a crypto wallet 2026-07-16f: a render error carries the component path it
    ...
    // trading-app report Ugly #3: right after a dev restart the server may still be
