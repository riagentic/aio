...
export type AioConfig<S, A, E> = {
   ...
   *  unless it asked for it (maintainer decision, a crypto wallet openWindow thread). */
...
export type CellsConfig = {
   ...
   *  supported disjoint-multi-app pattern. a crypto wallet 2026-07-24 Bad #2. */
  strictCells?: boolean;
   ...
   *  rejections (a synchronous uncaught throw is still fatal). a crypto wallet Bad #3. */
  guardDispatches?: boolean;
  /** Durable action journal (wallet report #3): every committed action is appended to
