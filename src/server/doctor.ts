...
/** Code-integrity sweep (a crypto wallet 2026-07-24 #3): the "green-tests-dead-feature /
 *  silent-corruption" class — reserved cell keys, duplicate imports, orphaned
 *  persistence, and the client/server boundary (wallet report #1 defect d: a
...
/** Least-privilege capability manifest for the project (wallet report #9) — the
...
export async function runDoctor(
  ...
  // aio version drift (a news app) — the app's import-map pin vs the framework
