 ...
 *
 *  The trap this closes (a crypto wallet, 2026-07-26): a worker holds only its own
...
export function startCellWorkerHost(cell: CellDef): Promise<never> {
  ...
  self.onmessage = async (ev: MessageEvent<ToWorker>) => {
    ...
    // success and failure alike (a crypto wallet 2026-08-01, a night of hardware-wallet
