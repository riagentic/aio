...
app.on('ready', () => {
  ...
  // "render remote content inside the app" capabilities (a crypto wallet RIB — the
...
${tmplBoundsTracking()}
  ...
  // moment a webview attached (a crypto wallet RIB field report 2026-07-25). Handles
