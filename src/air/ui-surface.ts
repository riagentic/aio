 ...
 *  how deeply it's nested (wallet report #2), instead of a positional component index. */
...
function walkOutput(
  ...
  if (typeof v.tag === "string") {
    ...
    // resolve it and assert `disabled: true`. (a news app R4 P1)
...
function walkComponent(
  ...
  // (a crypto wallet 2026-07-21). Deterministic dedupe: 2nd+ instances get #2, #3 …
