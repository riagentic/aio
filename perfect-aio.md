...
| — KV + SQLite dual persistence                                         | ✂️ reopen: SQLite-only                      | one engine, one mental model (a crypto wallet asked for exactly this)                                                      |
...
process; why `libraryMode` had to be invented (a trading platform report B5) as a patch; why
...
and what a crypto wallet asked for ("SQLite as first-class default"). I know Deno.Kv was
