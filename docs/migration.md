...
```jsonc
{
  ...
  "tasks": {
    ...
    "compile:browser": "deno run -A jsr:@riagentic/aio@1.0.0-alpha5/src/build --compile",
    "compile:electron": "deno run -A jsr:@riagentic/aio@1.0.0-alpha5/src/build --compile --electron",
    "compile:electron:remote": "deno run -A jsr:@riagentic/aio@1.0.0-alpha5/src/build --client",
    "compile:android": "deno run -A jsr:@riagentic/aio@1.0.0-alpha5/src/build --android"
  }
}
```
