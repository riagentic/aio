...
Zero external dependencies. A page that renders an aio component downloads **81
KB gzipped** (70 KB brotli); the counter app — that page plus one cell — is **83
KB gzipped** (72 KB brotli). That is the whole client: the renderer, the signal
