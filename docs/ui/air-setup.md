...
Zero external dependencies. A page that renders an aio component downloads **62
KB gzipped** (54 KB brotli); the counter app — that page plus one cell — is **64
KB gzipped** (56 KB brotli). That is the whole client: the renderer, the signal
