...
| `notify(opts)`    | A desktop-notification EFFECT for `s.$do(...)` — `{ title, body?, tag?, silent?, route? }`; shown by every connected UI client ([notifications](../clients/notifications.md))                                             |
...
| `TrayMenuItem`                                                                                                                                                 | One `ui.tray.menu` entry — `{ label, method?, args?, route? }` or `"-"`                                                                                                                                                                                                                                                                                                                                                                               |
