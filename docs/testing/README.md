...
| `smoke()`                              | every eagerly-linked client module is served (200, as JavaScript) by a real boot, with the static chain that loads it                                                                              | that any of them _evaluates_ without throwing                 |
