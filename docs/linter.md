...
deno run -A jsr:@riagentic/aio@1.0.0-alpha8/aiol/mod.ts
...
{
  "tasks": {
    "lint:aio": "deno run -A jsr:@riagentic/aio@1.0.0-alpha8/aiol/mod.ts"
  }
}
```
...
- [testing.md](testing.md) — testFeature harness, property-based testing
- [structure.md](structure.md) — recommended file organization
- [debugging.md](debugging.md) — runtime error identification
