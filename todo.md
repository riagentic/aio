...
## Harness fidelity — close the transport-boundary gap (a crypto wallet wish 1)
...
- [ ] **Cells-aware dev watch** (trading-app report Bad #3): auto-restart the server process
