...
// ── Shape drift (wallet report #1) — stored shape vs declared initialState ──────────
...
Deno.test("detectShapeDrift: a declared EMPTY object is an open record — stored keys are NOT drift", () => {
  // a field report 2026-07-25: `balances.sol = {} as Record<pubkey, number>`.
...
// a crypto wallet 2026-07-28 #2 — a restored snapshot replaces a seeded list wholesale.
