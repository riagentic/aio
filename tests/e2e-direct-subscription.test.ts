// a crypto wallet 2026-07-18 — CRITICAL regression: a server-initiated state change to a
...
Deno.test({
  name:
    "e2e: server-initiated change to a directly-read cell reaches a partially-subscribed client (a crypto wallet 2026-07-18)",
  ignore: BROWSER === null,
