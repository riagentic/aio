...
// a crypto wallet 2026-07-28 #3 — the warning was the ONLY signal, and a warning does not
...
// a crypto wallet, first field result of the dev-throw: aio tripped its OWN guard.
//
